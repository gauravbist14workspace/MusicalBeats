...
public class MusicService extends Service implements MediaPlayer.OnPreparedListener
    ...
    private void showNotification() {
        ...
        notificationView.setImageViewResource(R.id.notify_btn_previous, R.drawable.ic_prev);
        notificationView.setImageViewResource(R.id.notify_btn_next, R.drawable.ic_next);
        ...
        if(mState == STATE_PLAYING) {
            notificationView.setImageViewResource(R.id.btn_pause, R.drawable.ic_pause);
        } else if (mState == STATE_PAUSED) {
            notificationView.setImageViewResource(R.id.btn_pause, R.drawable.ic_play);
        } else {
            notificationView.setImageViewResource(R.id.btn_pause, R.drawable.ic_pause);
        }
        ...
        mNotification = new NotificationCompat.Builder(getApplicationContext(), CHANNEL_ID)
                ...
                .setOngoing(true)                                       // setOngoing() is set so swiping won't finish our notification though it's already foreground service
                .setWhen(System.currentTimeMillis())    				// when to fire up the notification
                .setContent(notificationView)           				// set the custom view
                .setDefaults(Notification.FLAG_NO_CLEAR)
                .setPriority(NotificationCompat.PRIORITY_LOW)           // this is not important !
                .setCategory(NotificationCompat.CATEGORY_MESSAGE)       // this is not important !
